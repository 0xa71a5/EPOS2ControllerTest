...
void initMotor()
{
  byte dataDefalutDealyTime[]= {0x11,0x02,0x20,0x05,0x1f,0x00,0x00,0x0B};
  byte dataVelocityMode[]=     {0x11,0x03,0x60,0x60,0x1f,0x00,0x00,0xFE,0x00,0x00};
  byte dataMaxSpeed[]=         {0x11,0x03,0x60,0x7f,0x1f,0x00,0x61,0xA8,0x00,0x00};
  byte dataStopMotor[]=        {0x11,0x03,0x60,0x40,0x1f,0x00,0x00,0x06,0x00,0x00};
  byte dataStartMotor[]=       {0x11,0x03,0x60,0x40,0x1f,0x00,0x00,0x0F,0x00,0x00};
